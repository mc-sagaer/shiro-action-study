package com.mch.common.config;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.mch.common.shiro.EnhanceModularRealmAuthenticator;
import com.mch.common.shiro.MyProjectProperties;
import com.mch.common.shiro.OAuth2Helper;
import com.mch.common.shiro.RestShiroFilterFactoryBean;
import com.mch.common.shiro.credential.RetryLimitHashedCredentialsMatcher;
import com.mch.common.shiro.filter.OAuth2AuthenticationFilter;
import com.mch.common.shiro.filter.RestAuthorizationFilter;
import com.mch.common.shiro.filter.RestFormAuthenticationFilter;
import com.mch.common.shiro.realm.OAuth2GiteeRealm;
import com.mch.common.shiro.realm.OAuth2GithubRealm;
import com.mch.common.shiro.realm.UserNameRealm;
import com.mch.system.service.ShiroService;
...
public class ShiroConfig {
    ...
    public RedisCacheManager redisCacheManager() {
        ...
        redisCacheManager.setExpire(myProjectProperties.getPermsCacheTimeout() == null ? 3600 : myProjectProperties.getPermsCacheTimeout());
    ...
    public RedisSessionDAO redisSessionDAO() {
        ...
        redisSessionDAO.setExpire(myProjectProperties.getSessionTimeout() == null ? 1800 : myProjectProperties.getSessionTimeout());
