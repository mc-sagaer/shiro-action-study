...
@Aspect
@Component
@ConditionalOnProperty(value = "my-project.log.operation", havingValue = "true")
public class OperationLogAspect {

    @Resource
    private SysLogMapper sysLogMapper;

    @Pointcut("@annotation(com.mch.common.annotation.OperationLog)")
    ...
    private void saveLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        if (args != null && paramNames != null) {
            ...
            for (int i = 0; i < args.length; i++) {
                params.append("  ").append(paramNames[i]).append(": ").append(JSONObject.toJSON(args[i]));
            }
