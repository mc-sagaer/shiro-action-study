...
import com.mch.common.util.ShiroUtil;
import com.mch.system.model.User;
import com.mch.system.service.UserService;
...
public class UserNameRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        if (ShiroUtil.USER_LOCK.equals(user.getStatus()) && !myProjectProperties.getSuperAdminUsername().equals(username)) {
    ...
    public boolean isPermitted(PrincipalCollection principals, String permission) {
        User user = (User) principals.getPrimaryPrincipal();
        return myProjectProperties.getSuperAdminUsername().equals(user.getUsername()) || super.isPermitted(principals, permission);
    }
    ...
    public boolean hasRole(PrincipalCollection principals, String roleIdentifier) {
        User user = (User) principals.getPrimaryPrincipal();
        return myProjectProperties.getSuperAdminUsername().equals(user.getUsername()) || super.hasRole(principals, roleIdentifier);
    }
}