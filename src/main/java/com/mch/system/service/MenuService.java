...
import com.mch.common.util.TreeUtil;
import com.mch.system.mapper.MenuMapper;
import com.mch.system.mapper.OperatorMapper;
import com.mch.system.mapper.RoleMenuMapper;
import com.mch.system.model.Menu;
...
public class MenuService {
    ...
    public List<Menu> selectMenuTreeVOByUsername(String username) {
        List<Menu> menus;
        if (myProjectProperties.getSuperAdminUsername().equals(username)) {
