...
import com.mch.common.exception.DuplicateNameException;
import com.mch.common.shiro.MyProjectProperties;
import com.mch.common.util.TreeUtil;
import com.mch.system.mapper.UserMapper;
import com.mch.system.mapper.UserRoleMapper;
...
//        offlineByUserId(id); // 加上这段代码, 禁用用户后, 会将当前在线的用户立即踢出.
    ...
    public void delete(Integer userId) {
        ...
        if (myProjectProperties.getSuperAdminUsername().equals(user.getUsername())) {
